<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminmdy.aspx.cs" Inherits="adminmdy" %>
...
<body>
	...
	<div class="Page_arrb arb_pr">
		...
		<input id="vcAdminName" disabled="disabled" type="text" runat="server" class="itxt1" onfocus="this.className='itxt2';SetInnerText($('adminmsg'),'登陆名称');"  onblur="CheckAdminName();"/>
