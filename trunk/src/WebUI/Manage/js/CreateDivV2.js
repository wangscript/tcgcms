...
function CreateDiv(){
	...
	this.CreateDivIntoPage=function(){
		...
		this.o.append("<div class=\"createclose\"><a onclick=\"$('CreateMsgPlace').className='MsgDiv hid';\"  href='javascript:GoTo();'></a></div><div class=\"createtitle\"><span id=\"createtitle\">操作正在进行中...</span></div><div class=\"createMsgbg\"><div class=\"createjdt\"><span style=\"margin-left:5px;\" id=\"Msg\"></span><span style=\"margin-left:15px;\">完成度:<span class=\"bold\" id=\"create_num\">0</span>%</span><div class=\"createjdtPlace\"><div class=\"createjdtPlacebg rbfcreate\" id=\"createjdtPlacebg\"></div></div></div><div class=\"createMsg\" id=\"MsgDiv\"></div><div class=\"createbottom\"></div></div>");
		$('body').append(this.o);
	}
}