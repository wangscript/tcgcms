...
namespace TCG.Handlers
{
    public class FileHandlers  
    {
        ...
        {
            return DataBaseFactory.FileHandlers.GetAllFilesClassFromDb();
        }
        ...
        public Dictionary<string, EntityBase> GetAllFileCategoriesEntity()
        {
            ...
            if (allfilecategories == null)
            {
                ...
                allfilecategories = HandlersFactory.GetEntitysObjectFromTable(dt, typeof(FileCategories));
        ...
        public FileResources GetFileInfosById(string id)
        {
            ...
            {
                DataTable dt = DataBaseFactory.FileHandlers.GetFileInfosById(id);
                if (dt != null)
                {
                    if (dt.Rows.Count == 1)
                    {
                        fileresource = (FileResources)HandlersFactory.GetEntityObjectFromRow(dt.Rows[0], typeof(FileResources));
