...
var ajaxicon = ['/TCG.ManageUI/images/ajax-loader1.gif','/TCG.ManageUI/images/post_err.gif','/TCG.ManageUI/images/post_ok.gif'];
var weisite = "/TCG.ManageUI/";
...
function SetAjaxLoad(obj,txt){
	obj.innerHTML = "<table width=\"98%\" height=\"16\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">"
	  			+ "<tr>"
	    +"<td width='1%'><img src='/TCG.ManageUI/images/ajax-loadersmall.gif' /></td>"
