...
"border-left:#CCCCCC solid 1px;border-top:1px solid #CCCCCC;border-right:1px solid #999999;border-bottom:1px solid #999999;";
//显示日的td的样式
...
tiannetPopCalendar(tiannetOutObject);
}
//用户主调函数－选择日期和小时
...
dads.left = pos.x + "px";
dads.top =	pos.y + obj.offsetHeight + "px";
tiannetShowControl();
selectObject();
}
//隐藏日历控件(同时显示被强制隐藏的标签)
