...
<script type="text/javascript">
    function OnSelFilePath(obj) {
        var DivNone = parent.document.getElementById("DivNone");
        if (DivNone) {
    ...
    function LoginCkBack(data) {
        if (data.Url) {
            ...
            parent.UpLodatFileBack(data.Url);
        }
    ...
    <table width='100%' border=0 cellSpacing=1 style='background:#9CD2FD' cellPadding=0>
		...
		<tr style='background:#ffffff'>
		    <td style='height:150px;text-align:left;padding-left:15px;color:#666666' valign=top>
	            ...
	            <br><input type="file" id="ifile" name="ifile" onprerender style="width:268px;" onclick="OnSelFilePath(this)" />
	            <br><br><b>对齐方式</b>:<br>
	            <input type='radio' onclick='FileAlign=null' name='FA' checked>无　
		...
		<tr style='background:#ffffff'>
		    <td style='height:30px'>
		        <input value='确定' type="submit" class="btn2 bold">　 
		     </td>
		 </tr>
		</table>
    </form>
