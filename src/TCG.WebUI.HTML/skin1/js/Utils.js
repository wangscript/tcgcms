	...
	this.convenientloginText = "<div class=\"DivBg\" id=\"DivBg\"></div><div class=\"loginDiv\" id=\"loginDiv\">"
      ...
      +"</div>"
        ...
        +"<div class=\"Registerinfo2\">"
            ...
            +"<div class=\"fl input2\"><input id=\"Validate_Code\" name=\"Validate_Code\" class=\"input fl\" style=\"width:80px;\" /><img src=\"http://code.tcgcms.cn/ValidCode.aspx?height=25&temp=\" class=\"fl maginleft5\" title=\"点击更换新的验证码\" align=\"absmiddle\" onclick=\"this.src=this.src + new Date().toString()\" /></div>"
